...
//	TH2D* h2_es = new TH2D("likelihood_ES", "likelihood_ES", nbinsEpsilon, 0.5, 5, nbinsX2, 0, 1000);
...
//for full root file
	TH2D* h2_dcp = new TH2D("energyscale vs dcp", "es vs dcp", nbinsCP, -1*TMath::Pi(), TMath::Pi(), nbinsEpsilon, 0.5, 5);
/*
...
//		h2_es->Fill(Epsilons[ESlocation], X2);
		h2_dcp->Fill(CP, Epsilons[ESlocation]);
...
//	std::string eps5 = "X2:"+eps;

        sX2->Draw(eps1.c_str(), "(S23>=0.5275)&&(S23<0.5281)&&(CP>=-1.57079633)&&(CP<1.57079632)&&(S13>=0.0215)&&(S13<0.022)&&(M23<=0.002502)&&(M23>0.002501)", "colz");
	c1->SaveAs(("correlation/NewInput_20211129/"+ModelType+ESType+EnergyScale+"_ES_CP_0.5En_Nominal.pdf").c_str());

//	sX2->Draw(eps5.c_str(), "(S23>=0.5275)&&(S23<0.5281)&&(CP>=-1.57079633)&&(CP<1.57079632)&&(S13>=0.0215)&&(S13<0.022)&&(M23<=0.002502)&&(M23>0.002501)", "colz");
//        c1->SaveAs(("correlation/0.5En/"+ModelType+ESType+EnergyScale+"_ES_X2_0.5En_Nominal.pdf").c_str());
/*
